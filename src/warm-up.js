...
/* we've not declared a "stockCount" variable, so I used the "inStock" variable
so I wouldn't get any errors in the terminal! */
...
var vegetables = ["Carrot", "Broccoli", "Beet", "Cabbage", "Raddish"];
...
var fruits = ["Mango", "Pineapple", "Strawberry", "Blueberry", "Orange",
"Banana", "Honeydew"];
...
/* any other property associated with the store that might be of interest, like:
hours, location, address, phone number, etc. */
